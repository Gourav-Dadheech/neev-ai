      ...
      <main className="relative flex-1 flex flex-col justify-center pt-40 pb-20 z-10 max-w-[105rem] w-full mx-auto">
        <div className="flex relative gap-4 px-6 md:items-center w-full flex-col justify-center">
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              NeeV.ai. Autonomous generative architecture & BIM platform.
            </motion.p>
          ...
          {/* Line 2: ARCHI [ZAP] TECT */}
          <div className="md:flex gap-8 items-center relative">
            <div className="relative">
              <div ref={linkedinRef} className="absolute -top-8 left-4 text-primary/60 hover:text-primary z-20 opacity-0">
                <a
                  href="https://neev-ai-ri5z.onrender.com"
                  target="_blank"
                  className="block text-sky-400 hover:text-sky-300 font-bold"
                  title="Open Live AI Studio"
                >
                  <Zap size={32} />
                </a>
              </div>
              ...
              >
                <span className="">ARCHI</span>
                <div
                  ref={zapRef}
                  className="hidden lg:block mx-[0.05em] relative cursor-pointer group"
                  onClick={() => window.open('https://neev-ai-ri5z.onrender.com', '_blank')}
                  onMouseEnter={(e) => setTooltip({ show: true, text: "🚀 Launch NeeV.ai Studio", icon: 'zap', x: e.clientX, y: e.clientY })}
          ...
          <div className="md:flex gap-8 items-center relative">
            <motion.h1
              ...
              className="text-[clamp(3rem,11vw,13rem)] md:flex items-center font-black leading-[0.85] tracking-tighter text-shiny will-change-transform px-4"
            >
              <span className="">ENGIN</span>
              <div
                ref={botRef}
                className="mx-[0.05em] relative cursor-pointer group"
                onClick={() => window.open('https://neev-ai-ri5z.onrender.com', '_blank')}
                onMouseEnter={(e) => setTooltip({ show: true, text: "💬 Talk to NeeV AI Architect", icon: 'bot', x: e.clientX, y: e.clientY })}
                onMouseMove={(e) => setTooltip(prev => ({ ...prev, x: e.clientX, y: e.clientY }))}
                onMouseLeave={() => setTooltip(prev => ({ ...prev, show: false }))}
              >
            ...
            <motion.p
              ...
              className="text-[10px] md:text-xs text-muted-foreground text-start leading-relaxed max-w-[200px] md:max-w-[220px] font-medium uppercase tracking-[0.2em]"
            >
              Transform conversational prompts into 2D CAD Blueprints, 3D WebGL, and itemized Civil BOQs.
            </motion.p>
          </div>

          {/* Quick CTA Button: Launch Studio */}
          <div className="mt-8 px-4 flex items-center gap-4">
            ...
            >
              <motion.div
                className="relative flex items-center bg-sky-500 hover:bg-sky-400 text-black h-12 px-6 rounded-full transition-all duration-300 shadow-xl font-black text-xs uppercase tracking-widest gap-2 cursor-pointer"
              >
                <span>🚀 Launch AI Studio (Start Journey)</span>
