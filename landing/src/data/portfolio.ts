...
export const portfolioData: PortfolioData = {
        personal: {
        name: 'NeeV.ai',
        title: 'Autonomous Spatial Architecture & BIM Platform',
        subtitle: 'Generative 2D CAD Blueprints • Real-Time 3D WebGL • CPWD Civil BOQ Estimations',
        bio: 'NeeV.ai is the world\'s first autonomous AI architecture and civil engineering platform designed to turn conversational prompts into municipality-compliant 2D CAD blueprints, interactive 3D WebGL models, itemized BOQs, and 100% Vastu Shastra compliant floor plans.',
        avatar: '/renders/living_room.jpg',
        location: 'Global Cloud Node • India',
        email: 'contact@neev.ai',
        phone: '+91-NEEV-AI-SPATIAL',
        resumeUrl: 'https://neev-ai-ri5z.onrender.com',
        ...
        socialLinks: [
            {
                platform: 'Live AI Studio',
                url: 'https://neev-ai-ri5z.onrender.com',
                icon: 'website',
                username: 'neev-ai.onrender.com',
            },
            {
                platform: 'GitHub',
                url: 'https://github.com/Gourav-Dadheech/neev-ai',
                icon: 'github',
                username: 'Gourav-Dadheech/neev-ai',
            },
        ],
    },
    projects: [
            ...
            description: 'Autonomous 2D CAD architectural blueprint with central courtyard micro-climate, cantilever balconies, and full real-time 3D WebGL orbit.',
            longDescription: 'NeeV.ai generated 30x50 East-facing luxury villa integrating traditional Indian Haveli courtyard cooling with ultra-modern architectural spatial zoning. Compliant with NBC 2016 setbacks and 100% Vastu Shastra rules.',
            techStack: ['FastAPI', 'Three.js WebGL', '2D CAD Blueprints', 'Groq Llama-3 70B', 'CPWD BOQ'],
            tools: ['NeeV Spatial Studio', 'Three.js Orbit', '2D Canvas CAD'],
            status: 'completed',
            repoUrl: 'https://github.com/Gourav-Dadheech/neev-ai',
            demoUrl: 'https://neev-ai-ri5z.onrender.com/?variant=courtyard',
            startDate: '2026-04-01',
            role: 'Autonomous AI Architect',
            customTimeline: 'Instant Generation (<30s)',
            ...
            features: [
                {
                    ...
                    items: [
                        '**Autonomous Spatial Zoning**: Living hall, modular kitchen in Agni (SE), puja room in Ishanya (NE), and master suite in Nairutya (SW).',
                        '**Municipal Bylaw Compliance**: Automated calculation of front, rear, and side setback clearances matching NBC 2016.',
                        '**Door/Window Schedule**: Automated schedule with clear sill and lintel heights.'
                    ]
                },
                {
                    title: 'Interactive 3D Virtual Twin',
                    items: [
                        '**Real-Time WebGL Orbit**: Pan, zoom, and inspect exterior wall elevations and interior partition layouts.',
                        '**Day / Night Lighting**: Solar shadow study for cross-ventilation and natural lighting analysis.',
                        '**Roof & Floor Isolation**: 1-click toggle to isolate ground floor, first floor, and terrace pergola.'
                    ]
                },
                {
                    title: 'Itemized Civil Engineering BOQ',
                    items: [
                        '**Concrete Volume**: 42.6 cubic meters (M20 grade concrete for slabs, beams & columns).',
                        '**Structural Rebar**: 3,420 kg of Fe500 grade thermo-mechanically treated (TMT) steel.',
                        '**Brickwork & Plastering**: Standard CPWD schedule of rates itemized costing.'
                    ]
                }
            ],
            installation: [
